<template>
  <el-card class="box-card" shadow="never" style="margin-bottom: 10px"
    ...
    <div slot="header" class="clearfix">Server group<i class="header-icon el-icon-info"></i>(深色标签拥有管理员权限)</div>
    <div class="tag-group">
      <span v-for="item in userDetail.serverGroups" :key="item.id">
...
export default {
  props: ['userDetail'],
  name: 'UserDetailServerGroupCard'
}
</script>
