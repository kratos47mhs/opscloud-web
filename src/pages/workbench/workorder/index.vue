  ...
  <d2-container>
    <template>
      ...
      <el-tabs v-model="tabActiveName" @tab-click="handleClick">
        ...
        <el-tab-pane label="工单统计" name="workorderReport">
          <workorder-report-table ref="workorderReportTable"></workorder-report-table>
        </el-tab-pane>
      </el-tabs>
    </template>
  </d2-container>
...
export default {
  ...
  methods: {
    ...
    handleClick (tab, event) {
      if (tab.name === 'workorderReport') {
        this.$refs.workorderReportTable.initReport()
      }
    }
  }
}
